...
var AccessToken = function (accessToken, refreshToken, expireTime) {
...
var processToken = function (that, callback) {
  return function (err, data, res) {
    ...
    that.token = AccessToken(data.access_token, data.refresh_token, expireTime);
 ...
 */
var OAuth = function (appid, appsecret, getToken) {
  this.appid = appid;
...
OAuth.prototype.refreshAccessToken = function (callback) {
  ...
  var info = {
    ...
    refresh_token: that.token.refreshToken
  };
  var args = {
    data: info,
    dataType: 'json'
